...
public class Calculation implements ActionListener {
    ...
    JLabel label8; // displays the gpa for one semester
    ...
    private int tracker = 1; // tracks adding removing
    private int swapper = 1; // swaps calculation between with course and with semester

    private int c1; // individual credit calculation tracker
    private int g1; // individual grade calculation (float, int) tracker
    ...
    Calculation() {
        ...
        labeltotalcredit.setBounds(500, 460, 180, 30);
        ...
        label8 = new JLabel();
        label8.setBounds(500, 480, 220, 30);
        label8.setForeground(Color.black);
        label8.setVisible(false);
        mainFrame.add(label8);
        ...
        // for picture
        label4 = new JLabel();
        label4.setIcon(new ImageIcon(getClass().getResource("/images/calc.png")));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == button4) { // button name
            switch (swapper) {
                case 1:
                    ...
                    // turns off the past calculation
                    labeltotalcredit.setVisible(false);
                    labeltotalgrade.setVisible(false);
                    label8.setVisible(false);
                    // makes the default first value in each text fields to zero
                    c1Field.setText("0");
                    g1Field.setText("0");
                    c1 = 1;
                    g1 = 1;
        ...
        if (e.getSource() == button4 && swapper == 1) {
            ...
            g4Field.setText("0");
            g5Field.setText("0");
            // now turns the course wise on
            c1Label.setVisible(true);
            label1.setVisible(true);
            label3.setVisible(true);
        }

        if (e.getSource() == button5 && swapper == 1) { // individual credit calculation with course
            int x = 0;
            int y = 0;
            float temp = 0;
            float gpa = 0;
            ...
            // gpa calculation course wise
            if (x == 1 && y == 1) {
                temp = Integer.parseInt(c1Field.getText()) * Float.parseFloat(g1Field.getText());
            } else if (x == 2 && y == 2) {
                temp = (Integer.parseInt(c1Field.getText()) * Float.parseFloat(g1Field.getText())
                        + Integer.parseInt(c2Field.getText()) * Float.parseFloat(g2Field.getText()));
            } else if (x == 3 && y == 3) {
                temp = (Integer.parseInt(c1Field.getText()) * Float.parseFloat(g1Field.getText())
                        + Integer.parseInt(c2Field.getText()) * Float.parseFloat(g2Field.getText())
                        + Integer.parseInt(c3Field.getText()) * Float.parseFloat(g3Field.getText()));
            } else if (x == 4 && y == 4) {
                temp = (Integer.parseInt(c1Field.getText()) * Float.parseFloat(g1Field.getText())
                        + Integer.parseInt(c2Field.getText()) * Float.parseFloat(g2Field.getText())
                        + Integer.parseInt(c3Field.getText()) * Float.parseFloat(g3Field.getText())
                        + Integer.parseInt(c4Field.getText()) * Float.parseFloat(g4Field.getText()));
            } else if (x == 5 && y == 5) {
                temp = (Integer.parseInt(c1Field.getText()) * Float.parseFloat(g1Field.getText())
                        + Integer.parseInt(c2Field.getText()) * Float.parseFloat(g2Field.getText())
                        + Integer.parseInt(c3Field.getText()) * Float.parseFloat(g3Field.getText())
                        + Integer.parseInt(c4Field.getText()) * Float.parseFloat(g4Field.getText())
                        + Integer.parseInt(c5Field.getText()) * Float.parseFloat(g5Field.getText()));
            } else {

            }
            gpa = temp / totalcredit;
            label8.setText("Your GPA for this semester: " + String.format("%.2f", gpa));
            label8.setVisible(true);
        }

        // semester wise
        if (e.getSource() == button5 && swapper == 0) {
            int k = 0;
            int l = 0;
            float temp = 0;
            float gpa = 0;
            ...
            labeltotalcredit.setText("Your toal credit is: " + totalcredit);
            labeltotalcredit.setVisible(true);
            // gpa calculation semeseter wise
            gpa = (float) totalgrade / k;
            label8.setText("Your CGPA is: " + String.format("%.2f", gpa));
            label8.setVisible(true);
        }
    }
}
